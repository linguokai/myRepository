...
/* eslint-disable */
const urlHead = 'http://106.53.245.88/ziyuan/public/index.php/'
    // const urlHead = 'http://127.0.0.1/ziyuan/public/index.php/'
...
const req = function(url, method, params, requestHeader, fileConfig = {}) {
    ...
    let requestConfig = {
        url: url,
        method: method,
        params: Object.assign({}, params, { access_token: '' }),
        data: qs.stringify(Object.assign({}, params, { access_token: '' })),
        headers: {},
